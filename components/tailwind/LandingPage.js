...
const footerNavigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://facebook.com/fluffsandfiles/',
      icon: FacebookIcon,
    },
    {
      name: 'Instagram',
      href: 'https://instagram.com/fluffsandfiles',
      icon: InstagramIcon,
    },
  ],
}
...
export default function Example() {
  return (
    <div className="bg-white">
      ...
      {/* Footer section */}
      <footer className="mt-24 bg-brandback sm:mt-12">
        <div className="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-200">&copy; 2021 Fluffs and Files</p>
        </div>
      </footer>
    </div>
  )
